...
Source: https://www.tradingview.com/script/5FQgMCiO-Adaptive-Candlestick-Pattern-Recognition-System/
...
priorTestVal = TEST_VAL[ i_PnLSample ]
...
if not na( priorTestVal )
        ...
        percentReturn = ( (close - open[ i_PnLSample ] ) / open[ i_PnLSample ] ) * 100%
        
        array.push(matrixReturn.returns, percentReturn)[/pine]
...
[pine]type returnArray
        float[] returns = na
        int size = 0
        float avg = 0
        float median = 0
        float stdDev = 0
        int[] polarities = na[/pine]
...
9 — Doji Settings, some pulled from an old [Doji Hunter](https://www.tradingview.com/script/nHtg6NbQ-Doji-Hunter/) I made a while back:
...
Private Beta for new features to be tested can be found [here](https://www.tradingview.com/script/BJGx267X-Adaptive-Candlestick-Pattern-Recognition-System-PEB-BETA/).
