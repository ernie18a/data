<!-- tradingview-pine-id: PUB;c2b66e6f5b254b549a721bdb7843e1b1 -->
<!-- tradingview-pine-version: 1.0 -->
<!-- tradingviewscripts-format: 1 -->
# Session Fibs | Falcon AI

Source: https://www.tradingview.com/script/dHjOZP9H-Session-Fibs-Falcon-AI/

## Description

Auto-draws Fibonacci retracement levels across a trading session's range, anchored to that session's own high and low.
...
Educational tool only. Not financial advice. Fib levels are reference points, not predictions.
