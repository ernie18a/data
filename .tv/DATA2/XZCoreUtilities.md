...
//@version=6
//@description XZ Core Utilities v3. Generic formatting, identifier parsing, neutral geometry and alert-dispatch helpers for XZ scripts. Contains no indicator-specific methodology, event authority or analytical qualification.
...
//==============================================================================
// GENERIC ALERT DISPATCH
//==============================================================================

//@function Dispatches a non-empty caller-built alert message once per bar close. The importing script remains authority for event existence, admission and message meaning.
export dispatchAlertOncePerBarClose(string message) =>
    if str.length(message) > 0
        alert(message, alert.freq_once_per_bar_close)
    true

//@function Dispatches a non-empty caller-built alert message once per bar. The importing script remains authority for event existence, admission and message meaning.
export dispatchAlertOncePerBar(string message) =>
    if str.length(message) > 0
