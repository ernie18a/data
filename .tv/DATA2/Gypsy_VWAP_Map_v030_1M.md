<!-- tradingview-pine-id: PUB;92d24150a1634cd882d4277bf90aa202 -->
<!-- tradingview-pine-version: 1.0 -->
<!-- tradingviewscripts-format: 1 -->
# Gypsy VWAP Map v0.30 1M

Source: https://www.tradingview.com/script/8YodMcwh-Gypsy-VWAP-Map-v0-30-1M-NonPremium-TV-version/
...
VWAP can reset at the Globex, London, and New York session anchors. I personally use all three, there is also an option for just NY + Globex.
...
````pine
//@version=6
indicator("Gypsy VWAP Map v0.30 1M", shorttitle = "VWAP 1M", overlay = true, behind_chart = true, format = format.price, max_bars_back = 5000, timeframe = "1", timeframe_gaps = false)
...
const string adaptiveTimeframe = "1"
...
const string persistentTimeframe = "1"
