...
tableLocationInput = input.string("Middle Center", "Table Location", options=["Top Left", "Top Center", "Top Right", "Middle Center", "Bottom Left", "Bottom Center", "Bottom Right"], group=groupDisplay, display=display.none)
...
isPreMarket = isWeekday and (newYorkHour < 9 or (newYorkHour == 9 and newYorkMinute < 30))
isRegularSession = isWeekday and ((newYorkHour > 9 or (newYorkHour == 9 and newYorkMinute >= 30)) and newYorkHour < 16)
...
f_scan_symbol() =>
    ...
    volatilityScore = math.min(atrPercent / math.max(targetAtrPercent, 0.01) * 8.0, 8.0)
    volumeScore = 0.0
    ...
    moveScore = f_clamp(trendQualityScore + alignmentScore + pressureMoveScore + speedMoveScore + volumeScore + volatilityScore + expansionScore + setupScore, 0.0, 100.0)
    [moveScore, directionValue, relativeVolume, squeezeValue, breakoutValue, structureValue, fvgValue, speedValue, trendStrengthValue, close]
//====================================================
...
// SYMBOL ARRAY
//====================================================
symbols = array.from(symbol01, symbol02, symbol03, symbol04, symbol05, symbol06, symbol07, symbol08, symbol09, symbol10, symbol11, symbol12, symbol13, symbol14, symbol15, symbol16, symbol17, symbol18, symbol19, symbol20)
//====================================================
// RESULT ARRAYS
//====================================================
scores = array.new_float()
directions = array.new_float()
priceValues = array.new_float()
...
//====================================================
f_push_result(float resultScore, float resultDirection, float resultPrice, float resultRvol, float resultSqueeze, float resultBreakout, float resultStructure, float resultFvg, float resultSpeed, float resultTrendStrength, float resultDailyAtr, float resultDailyHigh, float resultDailyLow) =>
    ...
    array.push(priceValues, nz(resultPrice, 0.0))
...
// REQUEST SYMBOL DATA
//====================================================
[score01, direction01, rvol01, squeeze01, breakout01, structure01, fvg01, speed01, trendStrength01, price01] = request.security(symbol01, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score02, direction02, rvol02, squeeze02, breakout02, structure02, fvg02, speed02, trendStrength02, price02] = request.security(symbol02, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score03, direction03, rvol03, squeeze03, breakout03, structure03, fvg03, speed03, trendStrength03, price03] = request.security(symbol03, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score04, direction04, rvol04, squeeze04, breakout04, structure04, fvg04, speed04, trendStrength04, price04] = request.security(symbol04, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score05, direction05, rvol05, squeeze05, breakout05, structure05, fvg05, speed05, trendStrength05, price05] = request.security(symbol05, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score06, direction06, rvol06, squeeze06, breakout06, structure06, fvg06, speed06, trendStrength06, price06] = request.security(symbol06, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score07, direction07, rvol07, squeeze07, breakout07, structure07, fvg07, speed07, trendStrength07, price07] = request.security(symbol07, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score08, direction08, rvol08, squeeze08, breakout08, structure08, fvg08, speed08, trendStrength08, price08] = request.security(symbol08, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score09, direction09, rvol09, squeeze09, breakout09, structure09, fvg09, speed09, trendStrength09, price09] = request.security(symbol09, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score10, direction10, rvol10, squeeze10, breakout10, structure10, fvg10, speed10, trendStrength10, price10] = request.security(symbol10, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score11, direction11, rvol11, squeeze11, breakout11, structure11, fvg11, speed11, trendStrength11, price11] = request.security(symbol11, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score12, direction12, rvol12, squeeze12, breakout12, structure12, fvg12, speed12, trendStrength12, price12] = request.security(symbol12, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score13, direction13, rvol13, squeeze13, breakout13, structure13, fvg13, speed13, trendStrength13, price13] = request.security(symbol13, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score14, direction14, rvol14, squeeze14, breakout14, structure14, fvg14, speed14, trendStrength14, price14] = request.security(symbol14, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score15, direction15, rvol15, squeeze15, breakout15, structure15, fvg15, speed15, trendStrength15, price15] = request.security(symbol15, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score16, direction16, rvol16, squeeze16, breakout16, structure16, fvg16, speed16, trendStrength16, price16] = request.security(symbol16, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score17, direction17, rvol17, squeeze17, breakout17, structure17, fvg17, speed17, trendStrength17, price17] = request.security(symbol17, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score18, direction18, rvol18, squeeze18, breakout18, structure18, fvg18, speed18, trendStrength18, price18] = request.security(symbol18, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score19, direction19, rvol19, squeeze19, breakout19, structure19, fvg19, speed19, trendStrength19, price19] = request.security(symbol19, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
[score20, direction20, rvol20, squeeze20, breakout20, structure20, fvg20, speed20, trendStrength20, price20] = request.security(symbol20, scanTimeframe, f_scan_symbol(), gaps=barmerge.gaps_off, lookahead=barmerge.lookahead_off, ignore_invalid_symbol=true, calc_bars_count=300)
...
// STORE RESULTS
//====================================================
f_push_result(score01, direction01, price01, rvol01, squeeze01, breakout01, structure01, fvg01, speed01, trendStrength01, dailyAtr01, dailyHigh01, dailyLow01)
f_push_result(score02, direction02, price02, rvol02, squeeze02, breakout02, structure02, fvg02, speed02, trendStrength02, dailyAtr02, dailyHigh02, dailyLow02)
f_push_result(score03, direction03, price03, rvol03, squeeze03, breakout03, structure03, fvg03, speed03, trendStrength03, dailyAtr03, dailyHigh03, dailyLow03)
f_push_result(score04, direction04, price04, rvol04, squeeze04, breakout04, structure04, fvg04, speed04, trendStrength04, dailyAtr04, dailyHigh04, dailyLow04)
f_push_result(score05, direction05, price05, rvol05, squeeze05, breakout05, structure05, fvg05, speed05, trendStrength05, dailyAtr05, dailyHigh05, dailyLow05)
f_push_result(score06, direction06, price06, rvol06, squeeze06, breakout06, structure06, fvg06, speed06, trendStrength06, dailyAtr06, dailyHigh06, dailyLow06)
f_push_result(score07, direction07, price07, rvol07, squeeze07, breakout07, structure07, fvg07, speed07, trendStrength07, dailyAtr07, dailyHigh07, dailyLow07)
f_push_result(score08, direction08, price08, rvol08, squeeze08, breakout08, structure08, fvg08, speed08, trendStrength08, dailyAtr08, dailyHigh08, dailyLow08)
f_push_result(score09, direction09, price09, rvol09, squeeze09, breakout09, structure09, fvg09, speed09, trendStrength09, dailyAtr09, dailyHigh09, dailyLow09)
f_push_result(score10, direction10, price10, rvol10, squeeze10, breakout10, structure10, fvg10, speed10, trendStrength10, dailyAtr10, dailyHigh10, dailyLow10)
f_push_result(score11, direction11, price11, rvol11, squeeze11, breakout11, structure11, fvg11, speed11, trendStrength11, dailyAtr11, dailyHigh11, dailyLow11)
f_push_result(score12, direction12, price12, rvol12, squeeze12, breakout12, structure12, fvg12, speed12, trendStrength12, dailyAtr12, dailyHigh12, dailyLow12)
f_push_result(score13, direction13, price13, rvol13, squeeze13, breakout13, structure13, fvg13, speed13, trendStrength13, dailyAtr13, dailyHigh13, dailyLow13)
f_push_result(score14, direction14, price14, rvol14, squeeze14, breakout14, structure14, fvg14, speed14, trendStrength14, dailyAtr14, dailyHigh14, dailyLow14)
f_push_result(score15, direction15, price15, rvol15, squeeze15, breakout15, structure15, fvg15, speed15, trendStrength15, dailyAtr15, dailyHigh15, dailyLow15)
f_push_result(score16, direction16, price16, rvol16, squeeze16, breakout16, structure16, fvg16, speed16, trendStrength16, dailyAtr16, dailyHigh16, dailyLow16)
f_push_result(score17, direction17, price17, rvol17, squeeze17, breakout17, structure17, fvg17, speed17, trendStrength17, dailyAtr17, dailyHigh17, dailyLow17)
f_push_result(score18, direction18, price18, rvol18, squeeze18, breakout18, structure18, fvg18, speed18, trendStrength18, dailyAtr18, dailyHigh18, dailyLow18)
f_push_result(score19, direction19, price19, rvol19, squeeze19, breakout19, structure19, fvg19, speed19, trendStrength19, dailyAtr19, dailyHigh19, dailyLow19)
f_push_result(score20, direction20, price20, rvol20, squeeze20, breakout20, structure20, fvg20, speed20, trendStrength20, dailyAtr20, dailyHigh20, dailyLow20)
//====================================================
// SORT RESULTS
//====================================================
...
f_score_color(float value) =>
    ...
    resultColor
f_setup_text(float squeezeValue, float breakoutValue, float structureValue, float fvgValue, float directionValue) =>
...
// TOP 10 TABLE
//====================================================
var table radarTable = table.new(tablePosition, 12, 22, border_width=1, frame_width=1)
if barstate.islast
    table.clear(radarTable, 0, 0, 11, 21)
    ...
    table.cell(radarTable, 2, 1, "Price", text_color=color.white, bgcolor=headerColor)
    table.cell(radarTable, 3, 1, "Score", text_color=color.white, bgcolor=headerColor)
    table.cell(radarTable, 4, 1, "Dir", text_color=color.white, bgcolor=headerColor)
    table.cell(radarTable, 5, 1, "Setup", text_color=color.white, bgcolor=headerColor)
    table.cell(radarTable, 6, 1, "RVOL", text_color=color.white, bgcolor=headerColor)
    table.cell(radarTable, 7, 1, "ATR", text_color=color.white, bgcolor=headerColor)
    table.cell(radarTable, 8, 1, "ATR Used", text_color=color.white, bgcolor=headerColor)
    table.cell(radarTable, 9, 1, "Speed", text_color=color.white, bgcolor=headerColor)
    table.cell(radarTable, 10, 1, "T-Strength", text_color=color.white, bgcolor=headerColor)
    table.cell(radarTable, 11, 1, "Evidence", text_color=color.white, bgcolor=headerColor)
    for resultRow = 0 to topResults - 1
        ...
        rowPrice = array.get(priceValues, sortedIndex)
        ...
        evidenceText = (rowSqueeze > 0.0 ? "SQZ " : "") + (rowBreakout != 0.0 ? "BRK " : "") + (rowStructure != 0.0 ? "S/D " : "") + (rowFvg != 0.0 ? "FVG" : "")
        ...
        table.cell(radarTable, 0, tableRow, str.tostring(resultRow + 1), text_color=color.white, bgcolor=neutralColor)
        table.cell(radarTable, 1, tableRow, rowSymbol, text_color=color.white, bgcolor=neutralColor)
        table.cell(radarTable, 2, tableRow, "$" + str.tostring(rowPrice, "#.00"), text_color=color.white, bgcolor=neutralColor)
        table.cell( radarTable, 3, tableRow, str.tostring(rowScore, "#.0"), text_color=color.white, bgcolor=scoreBackground )
        table.cell( radarTable, 4, tableRow, f_direction_text(rowDirection), text_color=color.white, bgcolor=directionBackground )
        table.cell( radarTable, 5, tableRow, f_setup_text( rowSqueeze, rowBreakout, rowStructure, rowFvg, rowDirection ), text_color=color.white, bgcolor=scoreBackground )
        table.cell( radarTable, 6, tableRow, str.tostring(rowRvol, "#.00") + "x", text_color=color.white, bgcolor=rowRvol >= highRelativeVolume ? color.new(color.orange, 55) : neutralColor )
        table.cell( radarTable, 7, tableRow, "$" + str.tostring(rowAtrAmount, "#.00"), text_color=color.white, bgcolor=neutralColor )
        table.cell( radarTable, 8, tableRow, atrDisplayText, text_color=color.white, bgcolor=neutralColor )
        table.cell( radarTable, 9, tableRow, str.tostring(rowSpeed, "#.00"), text_color=color.white, bgcolor=rowSpeed >= 0.25 ? color.new(color.orange, 60) : neutralColor )
        table.cell( radarTable, 10, tableRow, f_trend_text(rowTrendStrength), text_color=color.white, bgcolor=rowTrendStrength >= 3.0 and rowDirection != 0.0 ? directionBackground : neutralColor )
        table.cell( radarTable, 11, tableRow, evidenceText, text_color=color.white, bgcolor=neutralColor )
//====================================================
// DYNAMIC TOP SYMBOL ALERT
//====================================================
topCandidateIndex = array.get(sortedIndices, 0)
topCandidateSymbol = f_clean_symbol( array.get(symbols, topCandidateIndex) )
topCandidateScore = array.get( scores, topCandidateIndex )
topCandidateDirection = array.get( directions, topCandidateIndex )
topCandidateRvol = array.get( rvolValues, topCandidateIndex )
topCandidateAtr = array.get( atrValues, topCandidateIndex )
...
thresholdCrossed = topCandidateScore >= minimumAlertScore and previousTopScore < minimumAlertScore
alertReady = topCandidateScore >= minimumAlertScore and (not alertOnlyWhenLeaderChanges or leaderChanged or directionChanged or thresholdCrossed)
if barstate.isrealtime and barstate.isconfirmed and alertReady
    alertMessage = "STP Large Move Radar | " + topCandidateSymbol + " | Direction: " + f_direction_text(topCandidateDirection) + " | Score: " + str.tostring(topCandidateScore, "#.0") + " | RVOL: " + str.tostring(topCandidateRvol, "#.00") + "x | ATR Used: " + topCandidateAtrText + " | Timeframe: " + scanTimeframe
