...
if barstate.islast
    ...
    if not assetFound
        ...
        table.cell(infoTable, 0, 0, headerTxt, text_color = volState == "red" ? color.red : volState == "yellow" ? color.yellow : color.white, bgcolor=color.new(color.blue, 55), text_size=txtSize)
        ...
        table.cell(infoTable, 1, 2, str.tostring(stopDistance, "#.##") + " pts / " + str.tostring(stopTicks, "#") + " ticks",
             text_color = volState == "red" ? color.red : volState == "yellow" ? color.yellow : color.white, text_size=txtSize)
