...
Source: https://www.tradingview.com/script/0h0gKNcy-120x-ticker-screener-composite-tickers/

## Description

In specific circumstances, it is possible to extract data, far above the [40 `request.*()` call limit](https://www.tradingview.com/pine-script-reference/v5/#fun_request.security) for 1 single script .
The following [technique](https://www.tradingview.com/chart/AAPL/ZtMqr022-Create-Your-Own-Formula-and-Chart-It/) uses [composite tickers](https://www.tradingview.com/chart/AAPL/vVeR8e01-Working-with-combined-calculated-tickers-coding-tool/). Changing tickers needs to be done in the code itself as will be explained further.
...
•••
[o16, h16, l16, c16] = request.security(T16, res, [open, high, low, close])
•••
...
[pine]
t46 = 'BINANCE:MTLUSDT', n46 = 10e8 , r46 = 3, t47 = 'BINANCE:XMRUSDT', n47 = 10e1, r47 = 1, t48 = 'BINANCE:ORNUSDT', r48 = 4 // T16
[/pine] (t46, T16,... will be explained later)
...
[image]https://www.tradingview.com/x/d7U2dLUm/[/image]

[image]https://www.tradingview.com/x/fWhFL52g/[/image]
...
[*]SHOW SETS
[image]https://www.tradingview.com/x/8XadvSiO/[/image]

[image]https://www.tradingview.com/x/zU31v52N/[/image]
...
[image]https://www.tradingview.com/x/O3wrsRin/[/image]
[image]https://www.tradingview.com/x/lKoq1alQ/[/image]
...
[image]https://www.tradingview.com/x/uMgdVMJw/[/image]
...
 • REGEX ([Regular expression](https://en.wikipedia.org/wiki/Regular_expression#Perl_and_PCRE)) and [str.match()](https://www.tradingview.com/pine-script-reference/v5/#fun_str.match) is used to delete the exchange name from the ticker, in other words, everything before ":" is deleted by following regex:
[pine]exch(t) => incl_exch ? t : str.match(t, "(?<=:)[\\w]+")[/pine]

 • To sort, [array.sort_indices()](https://www.tradingview.com/pine-script-reference/v5/#fun_array.sort_indices) is used (line 675 in the code), just as in my first "sort" publication [Sort array alphabetically - educational](https://www.tradingview.com/script/LVEJF1Iy-Sort-array-alphabetically-educational/)
...
 • Numbers and text colour will adjust automatically when switching between light/dark mode by using [chart.fg_color](https://www.tradingview.com/pine-script-reference/v5/#var_chart.fg_color) / [chart.bg_color](https://www.tradingview.com/pine-script-reference/v5/#var_chart.bg_color)
[image]https://www.tradingview.com/x/fYi1Kf7f/[/image]
[image]https://www.tradingview.com/x/jIYdlegz/[/image]
