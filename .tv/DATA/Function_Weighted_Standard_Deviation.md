...
Source: https://www.tradingview.com/script/F6fK5IMa-Function-Weighted-Standard-Deviation/

## Description

Calculates weighted mean, variance, standard deviation, MSE and RMSE from time series variables or arrays.
When calculating from arrays, the function expects index 0 to be the most recent sample and weight values.
