...
alertcondition(crossUp, title="BULL Ball-X1 Present 🔵", message="Bull Ball-X1 🔵 — Present")
alertcondition(crossDn, title="Bear Ball-X2 Present 🟠", message="Bear Ball-X2 🟠 — Present")

// === BALL — PAST ===

alertcondition(crossUpConfirmed, title="Ball-X1 Bull Past 🟦", message="Ball-X1 Bull 🟦 — Past")
alertcondition(crossDnConfirmed, title="Ball-X2 Bear Past 🟧", message="Ball-X2 Bear 🟧 — Past")
...
alertcondition(waveBullChange, title="Wave Bull Present 🟢", message="Wave Bull 🟢 — Present")
alertcondition(waveBearChange, title="Wave Bear Present 🔴", message="Wave Bear 🔴 — Present")

// === WAVE — PAST ===

alertcondition(waveBullChangeConfirmed, title="Wave Bull Past 🟩", message="Wave Bull 🟩 — Past")
alertcondition(waveBearChangeConfirmed, title="Wave Bear Past 🟥", message="Wave Bear 🟥 — Past")
````
