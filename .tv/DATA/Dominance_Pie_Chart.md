<!-- tradingview-pine-id: PUB;I5S83T8gcFhuIsYwBGhqMQeG4Rm4PaXX -->
<!-- tradingviewscripts-format: 1 -->
# Dominance Pie Chart

Source: https://www.tradingview.com/script/a4lgCDZ1-Dominance-Pie-Chart/

## Description

A different type of charting, the pie chart,
here for showing the available dominance on one chart,
together with the total % dominance per ticker and between brackets
the % rise/fall.

Can be used in every timeframe

(It is normal it takes some time to be loaded)
