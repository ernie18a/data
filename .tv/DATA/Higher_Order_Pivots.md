<!-- tradingview-pine-id: PUB;8PgdoVd3JQLBvxVYj7Pvr17adLyzUtBR -->
<!-- tradingviewscripts-format: 1 -->
# Higher Order Pivots

Source: https://www.tradingview.com/script/x2LlRvBe-Higher-Order-Pivots/

## Description

First order pivot points are defined as 3 or 5 bar "V" shaped patterns. For example a high with a lower high either side of the peak and in the case of the 5 bar variant with lower highs adjacent to a high below the peak.
...
[image]https://www.tradingview.com/x/OI8H7q7k/[/image]
Delineating market structure using 2nd order pivots derived from 3 bar, 1st order pivots

[image]https://www.tradingview.com/x/3tpk7aOq/[/image]
