...
Source: https://www.tradingview.com/script/iF0JGsN1-P-Square-Estimation-of-the-Nth-percentile-of-a-series/
...
One solution to this is to use an estimation algorithm to get close to the true percentile value. Therefore, I have ported this implementation of the [P-Square algorithm](https://github.com/viciious/psqr) to Pine Script. P-Square is a fast algorithm that does a good job at estimating percentiles in data streams. Here's the algorithms [original paper](https://www.cse.wustl.edu/~jain/papers/ftp/psqr.pdf).
