...
Source: https://www.tradingview.com/script/iJpIEMfW-Rolling-largest-Impulse-Murreys-Lines/
...
import RicardoSantos/FunctionArrayMaxSubKadanesAlgorithm/2 as msub
import RicardoSantos/ColorExtension/6 as colore
...
i_base_color = input.color(defval=color.silver, title='Base', inline='b', group=g_style, display=display.none)
i_base_extend = line_extend_switch(input.string(defval='none', options=['left', 'right', 'both', 'none'], title='', inline='b', group=g_style, display=display.none))
i_base_style = line_style_switch(input.string(defval='solid', options=['dashed', 'dotted', 'solid'], title='', inline='b', group=g_style, display=display.none))
i_base_width = input.int(defval=1, minval=0, title='', tooltip='Base line properties.', inline='b', group=g_style, display=display.none)
i_invr_color = input.color(defval=color.silver, title='Inverse', inline='i', group=g_style, display=display.none)
i_invr_extend = line_extend_switch(input.string(defval='none', options=['left', 'right', 'both', 'none'], title='', inline='i', group=g_style, display=display.none))
i_invr_style = line_style_switch(input.string(defval='dashed', options=['dashed', 'dotted', 'solid'], title='', inline='i', group=g_style, display=display.none))
i_invr_width = input.int(defval=1, minval=0, title='', tooltip='Inverse line properties.', inline='i', group=g_style, display=display.none)
i_extend = line_extend_switch(input.string(defval='left', options=['left', 'right', 'both', 'none'], title='MML Extend', inline='00', group=g_style, display=display.none))
i_labels = input.bool(defval=true, title='', inline='00', group=g_style, display=display.none)
i_labels_textsize = input.string(defval='small', options=['auto', 'huge', 'large', 'normal', 'small', 'tiny'], title='Labels', inline='00', group=g_style, display=display.none)
i_mm01_color  = input.color(defval=color.gray, title='-2/8',                                                        inline='01', group=g_style, display=display.none)
i_mm01_style  = line_style_switch(input.string(defval='dotted', options=['dashed', 'dotted', 'solid'], title='',    inline='01', group=g_style, display=display.none))
i_mm01_width  = input.int(defval=1, minval=0, title='', tooltip='-2/8 line properties.',                            inline='01', group=g_style, display=display.none)
i_mm02_color  = input.color(defval=color.gray, title='-1/8',                                                        inline='02', group=g_style, display=display.none)
i_mm02_style  = line_style_switch(input.string(defval='dashed', options=['dashed', 'dotted', 'solid'], title='',    inline='02', group=g_style, display=display.none))
i_mm02_width  = input.int(defval=1, minval=0, title='', tooltip='-1/8 line properties.',                            inline='02', group=g_style, display=display.none)
i_mm03_color  = input.color(defval=color.aqua, title=' 0/8',                                                        inline='03', group=g_style, display=display.none)
i_mm03_style  = line_style_switch(input.string(defval='solid' , options=['dashed', 'dotted', 'solid'], title='',    inline='03', group=g_style, display=display.none))
i_mm03_width  = input.int(defval=2, minval=0, title='', tooltip=' 0/8 line properties.',                            inline='03', group=g_style, display=display.none)
i_mm04_color  = input.color(defval=color.gray, title=' 1/8',                                                        inline='04', group=g_style, display=display.none)
i_mm04_style  = line_style_switch(input.string(defval='dashed' , options=['dashed', 'dotted', 'solid'], title='',   inline='04', group=g_style, display=display.none))
i_mm04_width  = input.int(defval=1, minval=0, title='', tooltip=' 1/8 line properties.',                            inline='04', group=g_style, display=display.none)
i_mm05_color  = input.color(defval=color.gray, title=' 2/8',                                                        inline='05', group=g_style, display=display.none)
i_mm05_style  = line_style_switch(input.string(defval='solid' , options=['dashed', 'dotted', 'solid'], title='',    inline='05', group=g_style, display=display.none))
i_mm05_width  = input.int(defval=1, minval=0, title='', tooltip=' 2/8 line properties.',                            inline='05', group=g_style, display=display.none)
i_mm06_color  = input.color(defval=color.gray, title=' 3/8',                                                        inline='06', group=g_style, display=display.none)
i_mm06_style  = line_style_switch(input.string(defval='dashed' , options=['dashed', 'dotted', 'solid'], title='',   inline='06', group=g_style, display=display.none))
i_mm06_width  = input.int(defval=1, minval=0, title='', tooltip=' 3/8 line properties.',                            inline='06', group=g_style, display=display.none)
i_mm07_color  = input.color(defval=color.lime, title=' 4/8',                                                        inline='07', group=g_style, display=display.none)
i_mm07_style  = line_style_switch(input.string(defval='solid' , options=['dashed', 'dotted', 'solid'], title='',    inline='07', group=g_style, display=display.none))
i_mm07_width  = input.int(defval=2, minval=0, title='', tooltip=' 4/8 line properties.',                            inline='07', group=g_style, display=display.none)
i_mm08_color  = input.color(defval=color.gray, title=' 5/8',                                                        inline='08', group=g_style, display=display.none)
i_mm08_style  = line_style_switch(input.string(defval='dashed' , options=['dashed', 'dotted', 'solid'], title='',   inline='08', group=g_style, display=display.none))
i_mm08_width  = input.int(defval=1, minval=0, title='', tooltip=' 5/8 line properties.',                            inline='08', group=g_style, display=display.none)
i_mm09_color  = input.color(defval=color.gray, title=' 6/8',                                                        inline='09', group=g_style, display=display.none)
i_mm09_style  = line_style_switch(input.string(defval='solid' , options=['dashed', 'dotted', 'solid'], title='',    inline='09', group=g_style, display=display.none))
i_mm09_width  = input.int(defval=1, minval=0, title='', tooltip=' 6/8 line properties.',                            inline='09', group=g_style, display=display.none)
i_mm10_color  = input.color(defval=color.gray, title=' 7/8',                                                        inline='10', group=g_style, display=display.none)
i_mm10_style  = line_style_switch(input.string(defval='dashed' , options=['dashed', 'dotted', 'solid'], title='',   inline='10', group=g_style, display=display.none))
i_mm10_width  = input.int(defval=1, minval=0, title='', tooltip=' 7/8 line properties.',                            inline='10', group=g_style, display=display.none)
i_mm11_color  = input.color(defval=color.aqua, title=' 8/8',                                                        inline='11', group=g_style, display=display.none)
i_mm11_style  = line_style_switch(input.string(defval='solid' , options=['dashed', 'dotted', 'solid'], title='',    inline='11', group=g_style, display=display.none))
i_mm11_width  = input.int(defval=2, minval=0, title='', tooltip=' 8/8 line properties.',                            inline='11', group=g_style, display=display.none)
i_mm12_color  = input.color(defval=color.gray, title=' 9/8',                                                        inline='12', group=g_style, display=display.none)
i_mm12_style  = line_style_switch(input.string(defval='dashed' , options=['dashed', 'dotted', 'solid'], title='',   inline='12', group=g_style, display=display.none))
i_mm12_width  = input.int(defval=1, minval=0, title='', tooltip=' 9/8 line properties.',                            inline='12', group=g_style, display=display.none)
i_mm13_color  = input.color(defval=color.gray, title='10/8',                                                        inline='13', group=g_style, display=display.none)
i_mm13_style  = line_style_switch(input.string(defval='dotted' , options=['dashed', 'dotted', 'solid'], title='',   inline='13', group=g_style, display=display.none))
i_mm13_width  = input.int(defval=1, minval=0, title='', tooltip='10/8 line properties.',                            inline='13', group=g_style, display=display.none)
// prepare data:
