...
//––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
    ...
    if showTickerTable
        // Create arrays for sorting: indices and correlation values
        ...
        for i = 0 to 39
            ...
            // Use -999 for na values so they sort to the end
            array.set(sortedCorrs, i, na(cVal) ? -999.0 : cVal)
        
        // Bubble sort by correlation (descending: highest first)
        for i = 0 to 38
            for j = 0 to 38 - i
        ...
        // Header row - left columns (Rank 1-20)
        ...
        // Header row - right columns (Rank 21-40)
        ...
        // Fill rows with sorted data (20 rows, 2 columns of tickers)
        for i = 0 to 19
            row = i + 1
            
            // LEFT COLUMN SET (Ranks 1-20, sorted indices 0-19)
            ...
            // Get correlation-based background color
            rowBg = getCorrColor(cVal)
            
            rank1 = i + 1  // Rank 1 to 20
            table.cell(tickerTable, 0, row, str.tostring(rank1), text_color = color.white, bgcolor = rowBg, text_size = size.tiny)
            ...
            // RIGHT COLUMN SET (Ranks 21-40, sorted indices 20-39)
            ...
            rank2 = i + 21  // Rank 21 to 40
            table.cell(tickerTable, 3, row, str.tostring(rank2), text_color = color.white, bgcolor = rowBg2, text_size = size.tiny)
