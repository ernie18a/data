<!-- tradingview-pine-id: PUB;9d1a51151a42494c88a5ed46d68a33e5 -->
<!-- tradingviewscripts-format: 1 -->
# [XeL]:trimmedHarrellDavis.weighted.quantileEstimator.outlierAbsDeviations

Source: https://www.tradingview.com/script/iiNI8Ml2-Weighted-Harrell-Davis-Quantile-Estimator-with-AbsoluteDeviation/
...
Purpose:
   ...
   In an effort searching better statistical tools for price distributions, I found the excellent work of [Andrey Akinshin](https://aakinshin.net/about/) that took me to port [some of their Math research contributions for the compute benchmarking field](https://aakinshin.net/posts/), and bring it here at the TradingView ecosystem to take a shot at the price distribution crazy fields.   For a better detail of what the weighted Harrell-Davis Quantile Estimator can do, who better than drink directly from the source at References:

References:

[*][Weighted Quantile Estimators.](https://aakinshin.net/posts/weighted-quantiles/)

[*][DoubleMAD outlier detector based on the Harrell-Davis quantile estimator.](https://aakinshin.net/posts/harrell-davis-double-mad-outlier-detector/)

[*][Unbiased median absolute deviation based on the Harrell-Davis quantile estimator.](https://aakinshin.net/posts/unbiased-mad-hd/)

[*][Quantile confidence intervals for weighted samples.](https://aakinshin.net/posts/weighted-quantiles-ci/)

Licensing:

This work is licensed under a [Attribution-NonCommercial-ShareAlike 4.0 International Copyright](https://creativecommons.org/licenses/by-nc-sa/4.0/) (c) 2021 (CC BY-NC-SA 4.0)

Copyright's & Mentions:

[*]The [Gamma Functions](http://github.com/mathnet/mathnet-numerics/src/Numerics/SpecialFunctions/Gamma.cs) & [Beta Probability Density Functions](http://github.com/mathnet/mathnet-numerics//src/Numerics/SpecialFunctions/Beta.cs) C# implementations by the Math.NET Numerics, part of the Math.NET Project.

[*]The [Regularized Incomplete (Left) Beta Function C# implementation](https://github.com/samtools/htslib/blob/master/kfunc.c) by the SAMTools, htslib project.

[*]The [Weighted Harrell-Davis Quantile estimator](https://github.com/AndreyAkinshin/perfolizer/blob/master/src/Perfolizer/Perfolizer/Mathematics/QuantileEstimators/HarrellDavisQuantileEstimator.cs); C# & R implementations by Andrey Akinshin.

[*]External PineScript code, methods, support & consultancy by @PineCoders staff with special mention for:
+  ["ma sorter ('sort by array' example)- JD"](https://www.tradingview.com/script/Mzc4dmq7-ma-sorter-sort-by-array-example-JD/) by @Duyck. 
