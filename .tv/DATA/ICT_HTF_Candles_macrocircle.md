<!-- tradingview-pine-id: PUB;3ed14ecd889844ecb3b051cda083d3ab -->
<!-- tradingviewscripts-format: 1 -->
# ICT HTF Candles (macrocircle)

Source: https://www.tradingview.com/script/dN0ZuKtG/

## Description

Hallo everyone 
Indikator ini di buat untuk melihat candle HTF ,  seperti model po3, setiap alligment timeframe anda membutuhkan penyesuaian candle, menyelaraskan setiap algntment candle.

 [image]https://www.tradingview.com/x/Ur3jfXaS/[/image]
...
// Curr Published: 1046
//@version=6
indicator('ICT HTF Candles (macrocircle)', overlay = true, max_boxes_count = 500, max_lines_count = 500, max_labels_count = 500, max_bars_back = 5000)
