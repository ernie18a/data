<!-- tradingview-pine-id: PUB;d655d77eafd74c259170fa2797c20768 -->
<!-- tradingview-pine-version: 1.0 -->
<!-- tradingviewscripts-format: 1 -->
# SPMA Trend | NAL

Source: https://www.tradingview.com/script/Q8RDxj5I-SPMA-Trend-NAL/
...
[pine]Ret = close - close[1]
Per = ta.percentrank(Ret, percentrank_lookback)
Gate = Per > percentile_gate[/pine]
...
[pine]residual = close - SPMA
[quantileUpper, quantileLower] = f_quantile_volatility(residual, VolLen, QuantilePct)[/pine]
...
[pine]upperBand = SPMA + finalUpper * VolMul
lowerBand = SPMA - finalLower * VolMul[/pine]
...
[pine]if SPMA > SPMA[1] and close > upperBand and (UseSlope ? SlopeGate : true)
NAL := 1[/pine]

A bearish regime is established when price moves below the lower adaptive boundary.

[pine]if close < lowerBand
NAL := -1[/pine]
