...
Source: https://www.tradingview.com/script/O6LCkLTf-Textmate-Language-for-Pine-Script-v5-2023-05/
...
//             {
//                "comment": "Improved type highlighting within <...>",
//                "match": "\\b(matrix|map|array)(?:<(?:([a-zA-Z_][a-zA-Z0-9_]*\\.)?([a-zA-Z_][a-zA-Z0-9_]*)\\s*\\,\\s*)?(?:([a-zA-Z_][a-zA-Z0-9_]*\\.)?([a-zA-Z_][a-zA-Z0-9_]*))>)",
//                "captures": {
//                   "1": { "name": "entity.name.class.pine" },
...
//                "match": "(?<=\\B)\\s*\\b(?!var\\s|varip\\s)(bool|color|float|int|string|line|label|box|table|linefill)\\b\\s*(?:\\[\\]\\s+)?(?=[\\s,]\\s*\\w|>)",
//                "captures": { "1": { "name": "keyword.operator.type.pine" } }
//             },
//             {
//                "comment": "// Match UDTs)",
//                "match": "(?>(?<!\\w)|var(?:ip)?\\s+)\\s*\\b(?!var\\s|varip\\s)(?:([a-zA-Z_][a-zA-Z0-9_]*\\.)?([a-zA-Z_][a-zA-Z0-9_]*))\\b\\s*(?:\\[\\]\\s+)?(?=[\\s,]\\s*\\w|>)",
//                "captures": {
//                   "1": { "name": "keyword.other.unit.pine" },
//                   "2": { "name": "keyword.operator.type.pine" }
//                }
...
//             {
//                "match": "\\\\[bfnrt]",
//                "name": "constant.character.escape.json.tm.pine"
//             },
//             {
//                "match": "(\\\\u)(?>(\\h{4})|([^\"].{,3}))",
//                "captures": {
...
//                   "3": {
//                      "name": "constant.numeric.tm.pine",
//                      "patterns": [
//                         {
//                            "match": "\\H+",
//                            "name": "invalid.illegal.regex.tm.pine"
//                         }
//                      ]
//                   }
//                }
...
//             {
//                "match": "\\\\.?|[\"\\x-\\x1F\\x7F]",
//                "name": "invalid.illegal.json.tm markup.underline regex.pine"
//             }
//          ]
//       },
//       "constants": {
...
//             {
//                "comment": "",
//                "match": "\\b(indicator|library|strategy)\\s*(?=\\s*\\()",
...
//             {
//                "comment": "",
//                "match": "\\b(?<!\\.)(bar_index|last_bar_index|last_bar_time|time|timenow|time_tradingday|time_close|close|high|hl2|hlc3|hlcc4|low|ohlc4|open|volume|abovebar|belowbar)\\b(?=:?)(?!\\s*(?:\\(|=(?!=)|:=))",
//                "name": "variable.language.pine"
//             },
//             {
//                "comment": "",
...
//             },
//             {
//                "begin": "^(?:(export\\s+)?(method\\s+)?(\\w+)\\s*(?=\\s*\\())",
//                "beginCaptures": {
//                   "1": { "name": "storage.modifier.ps.pine" },
//                   "2": { "name": "storage.modifier.ps.pine" },
//                   "3": { "name": "entity.name.function.ps.pine" }
//                },
//                "end": "(\\))\\s*(?==>)",
//                "endCaptures": {
//                   "1": { "name": "punctuation.definition.parameters.end.ps.pine" },
//                   "2": { "name": "punctuation.separator.ps.pine" }
//                },
//                "name": "entity.name.function.ps.pine"
//             },
//             {
//                "comment": "signatureHelpProvider highlighting regex",
//                "match": "(\\w+)(\\??:)[^\\n=]+",
//                "captures": {
//                   "0": { "name": "keyword.operator.type.pine" },
//                   "1": { "name": "constant.variable.pine" },
//                   "2": { "name": "punctuation.pine" }
//                }
//             }
//          ]
