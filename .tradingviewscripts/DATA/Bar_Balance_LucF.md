...
Source: https://www.tradingview.com/script/lcgCwWwI-Bar-Balance-LucF/
...
Traders used to work with my [Delta Volume Columns Pro](https://www.tradingview.com/script/F2ylEYOO-Delta-Volume-Columns-Pro-LucF/) will feel right at home in this indicator's Inputs. It has lots of options, allowing it to be used in many different ways. If you value the bar balance information this indicator mines, I hope you will find the time required to master the use of Bar Balance well worth the investment.
...
• You have the option of emptying the body of bars where volume does not increase, as does my [TLD](https://www.tradingview.com/script/SeO3jRdj-The-Lie-Detector-LucF/) indicator, the idea behind this being that movement on bars where volume does not increase is less relevant.
...
For coders
• For those interested in gradients, this script uses an advanced version of the Advance/Decline gradient function from the PineCoders [Color Gradient (16 colors) Framework](https://www.tradingview.com/script/EjLGV9qg-Color-Gradient-16-colors-Framework-PineCoders-FAQ/). It allows more precise control over the range, steps and min/max values of the gradients.
...
— [alexgrover](https://www.tradingview.com/u/alexgrover/) who helped me think through the dampening method used to attenuate signal lines on high ratios of neutral intrabars.
— A guy called Kuan who commented on a [Backtest Rookies presentation](https://backtest-rookies.com/2019/02/15/tradingview-volume-profile-with-lower-time-frame-data/) of their [Volume Profile indicator](https://www.tradingview.com/script/28iP8MSD-Volume-Profile-Intra-bar-Volume/). The technique I use to inspect intrabars is derived from Kuan's code.
— [theheirophant](https://www.tradingview.com/u/theheirophant/), my partner in the exploration of the sometimes weird abysses of `security()`’s behavior at intrabar resolutions.
— [midtownsk8rguy](https://www.tradingview.com/u/midtownsk8rguy/), my brilliant companion in mining the depths of Pine graphics. He is also the co-author of the [PineCoders Color Gradient Frameworks](https://www.tradingview.com/script/EjLGV9qg-Color-Gradient-16-colors-Framework-PineCoders-FAQ/).
