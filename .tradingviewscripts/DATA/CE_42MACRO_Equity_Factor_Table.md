...
Source: https://www.tradingview.com/script/b3PcU8qn-CE-42MACRO-Equity-Factor-Table/
...
[*]Dividend Compounders ( [symbol="AMEX:SPHD"]AMEX:SPHD[/symbol] )
[*]Mid Caps ( [symbol="AMEX:VO"]AMEX:VO[/symbol] )
[*]Emerging Markets ( [symbol="AMEX:EEM"]AMEX:EEM[/symbol] )
[*]Small Caps ( [symbol="AMEX:IWM"]AMEX:IWM[/symbol] )
[*]Mega Cap Growth ( [symbol="NASDAQ:QQQ"]NASDAQ:QQQ[/symbol] )
[*]Brazil ( [symbol="AMEX:EWZ"]AMEX:EWZ[/symbol] )
[*]United Kingdom ( [symbol="AMEX:EWU"]AMEX:EWU[/symbol] )
[*]Growth ( [symbol="AMEX:IWF"]AMEX:IWF[/symbol] )
[*]United States ( [symbol="AMEX:SPY"]AMEX:SPY[/symbol] )
[*]Japan ( [symbol="AMEX:DXJ"]AMEX:DXJ[/symbol] )
[*]Momentum ( [symbol="AMEX:MTUM"]AMEX:MTUM[/symbol] )
[*]China ( [symbol="AMEX:FXI"]AMEX:FXI[/symbol] )
[*]Low Beta ( [symbol="AMEX:SPLV"]AMEX:SPLV[/symbol] )
[*]International ex-US ( [symbol="NASDAQ:ACWX"]NASDAQ:ACWX[/symbol] )
[*]India ( [symbol="AMEX:INDA"]AMEX:INDA[/symbol] )
[*]Eurozone ( [symbol="AMEX:EZU"]AMEX:EZU[/symbol] )
[*]Quality ( [symbol="AMEX:QUAL"]AMEX:QUAL[/symbol] )
[*]Size ( [symbol="AMEX:OEF"]AMEX:OEF[/symbol] )
