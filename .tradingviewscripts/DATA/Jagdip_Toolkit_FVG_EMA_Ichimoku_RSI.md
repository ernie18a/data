<!-- tradingview-pine-id: PUB;6c0744247e0b45359711561da469db01 -->
<!-- tradingviewscripts-format: 1 -->
# Jagdip Toolkit FVG + EMA + Ichimoku + RSI

Source: https://www.tradingview.com/script/mCLGtZz4-Jagdip-Toolkit-FVG-EMA-Ichimoku-v1/
...
//@version=6
indicator('Jagdip Toolkit FVG + EMA + Ichimoku + RSI', shorttitle="SMC + 3EMA + Ichi + RSI", overlay=true, max_bars_back=5000, max_boxes_count=5000, max_lines_count=500)
