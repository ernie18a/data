...
Source: https://www.tradingview.com/script/mA35wHU5-R-R-Trading-System-Framework/
...
Backtest_A      = input.string("0. Stochastic", "     A)",  options = ["None", "0. Stochastic", "1. 2x MA Cross", "2. MACD", "3. Bollinger Bands", "4. Supertrend", "5. Stochastic (Short)", "6. 2x MA Cross (Short)", "7. MACD (Short)", "8. Bollinger Bands (Short)", "9. Supertrend (Short)"], group = "📈 BACKTESTING BOXES / LABELS / TRAILING STOP", inline = "1")
Backtest_B      = input.string("1. 2x MA Cross","  B)",     options = ["None", "0. Stochastic", "1. 2x MA Cross", "2. MACD", "3. Bollinger Bands", "4. Supertrend", "5. Stochastic (Short)", "6. 2x MA Cross (Short)", "7. MACD (Short)", "8. Bollinger Bands (Short)", "9. Supertrend (Short)"], group = "📈 BACKTESTING BOXES / LABELS / TRAILING STOP", inline = "1", tooltip = "Display 2 different trade types.\n\nCompare and contrast all the different components of the trades and their relationships with one another.\n\nThis system is designed to force you to consider Risk:Reward at all times throughout the trading process. Get creative but try your best to only include things that improve your decision-making process, create consistency, improve risk:reward concepts, and are realsitic once met with the brutal truth of the trading world.")

TTT_Activated   = input.bool    (true,      "Active",           group = "📊 TRADE TRACKING TABLE",        inline = "1")   
TTT_textSize    = input.string  ("normal" ,  "",                group = "📊 TRADE TRACKING TABLE",        inline = "1",   options = ["tiny", "small", "normal", "large"])
TTT_tableYpos   = input.string  ("top",  "",                    group = "📊 TRADE TRACKING TABLE",        inline = "1",   options = ["top", "middle", "bottom"])
TTT_tableXpos   = input.string  ("center",   "",                group = "📊 TRADE TRACKING TABLE",        inline = "1",   options = ["left", "center", "right"], tooltip = "- Activate Table\n- Text Size\n- Table Position (Y)\n- Table Position (X)")

RRT_Activated   = input.bool    (true,      "Active",           group = "📊 RISK:REWARD TABLE",           inline = "1",   tooltip = "")                                                      
RRT_textSize    = input.string  ("normal" , "",                 group = "📊 RISK:REWARD TABLE",           inline = "1",   options = ["tiny", "small", "normal", "large"])
RRT_tableYpos   = input.string  ("bottom",  "",                 group = "📊 RISK:REWARD TABLE",           inline = "1",   options = ["top", "middle", "bottom"])
RRT_tableXpos   = input.string  ("left",   "",                  group = "📊 RISK:REWARD TABLE",           inline = "1",   options = ["left", "center", "right"], tooltip = "- Activate Table\n- Text Size\n- Table Position (Y)\n- Table Position (X)")

L0_Activated    = input.bool    (true, "Active |  ",            group = "▷ 0. Stochastic",                inline = "1")                           
L0_SL_Value     = input.float   (2.,   "Stop %",    step = .25, group = "▷ 0. Stochastic",                inline = "1",   tooltip = "% of price. The Trailing Stop is built to only become active once the Trailing Stop is above the Entry price and uses the same % set here for the Entry Stop.") 
L0_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 0. Stochastic",                inline = "2")                           
L0_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 0. Stochastic",                inline = "2",   tooltip = "Multiple of the Stop % above. This represents your risk:reward ratio for each TP level.") 
L0_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 0. Stochastic",                inline = "3") 
L0_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 0. Stochastic",                inline = "3",   tooltip = "Multiple of the Stop % above. This represents your risk:reward ratio for each TP level.")

L1_Activated    = input.bool    (true, "Active |  ",            group = "▷ 1. 2x MA Cross",               inline = "1")
L1_SL_Value     = input.float   (2.5,  "Stop %",    step = .25, group = "▷ 1. 2x MA Cross",               inline = "1")
L1_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 1. 2x MA Cross",               inline = "2")
L1_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 1. 2x MA Cross",               inline = "2")
L1_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 1. 2x MA Cross",               inline = "3")
L1_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 1. 2x MA Cross",               inline = "3")

L2_Activated    = input.bool    (true, "Active |  ",            group = "▷ 2. MACD",                      inline = "1")
L2_SL_Value     = input.float   (2.,   "Stop %",    step = .25, group = "▷ 2. MACD",                      inline = "1")
L2_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 2. MACD",                      inline = "2")
L2_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 2. MACD",                      inline = "2")
L2_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 2. MACD",                      inline = "3")
L2_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 2. MACD",                      inline = "3")

L3_Activated    = input.bool    (true, "Active |  ",            group = "▷ 3. Bollinger Bands",           inline = "1")
L3_SL_Value     = input.float   (2.,   "Stop %",    step = .25, group = "▷ 3. Bollinger Bands",           inline = "1")
L3_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 3. Bollinger Bands",           inline = "2")
L3_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 3. Bollinger Bands",           inline = "2")
L3_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 3. Bollinger Bands",           inline = "3")
L3_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 3. Bollinger Bands",           inline = "3")

L4_Activated    = input.bool    (true, "Active |  ",            group = "▷ 4. Supertrend",                inline = "1")
L4_SL_Value     = input.float   (2.,   "Stop %",    step = .25, group = "▷ 4. Supertrend",                inline = "1")
L4_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 4. Supertrend",                inline = "2")
L4_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 4. Supertrend",                inline = "2")
L4_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 4. Supertrend",                inline = "3")
L4_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 4. Supertrend",                inline = "3")

S5_Activated    = input.bool    (true, "Active |  ",            group = "▷ 5. Stochastic (Short)",        inline = "1")
S5_SL_Value     = input.float   (2.,   "Stop %",    step = .25, group = "▷ 5. Stochastic (Short)",        inline = "1")
S5_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 5. Stochastic (Short)",        inline = "2")
S5_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 5. Stochastic (Short)",        inline = "2")
S5_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 5. Stochastic (Short)",        inline = "3")
S5_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 5. Stochastic (Short)",        inline = "3")

S6_Activated    = input.bool    (true, "Active |  ",            group = "▷ 6. 2x MA Cross (Short)",       inline = "1")
S6_SL_Value     = input.float   (2.,   "Stop %",    step = .25, group = "▷ 6. 2x MA Cross (Short)",       inline = "1")
S6_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 6. 2x MA Cross (Short)",       inline = "2")
S6_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 6. 2x MA Cross (Short)",       inline = "2")
S6_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 6. 2x MA Cross (Short)",       inline = "3")
S6_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 6. 2x MA Cross (Short)",       inline = "3")

S7_Activated    = input.bool    (true, "Active |  ",            group = "▷ 7. MACD (Short)",              inline = "1")
S7_SL_Value     = input.float   (2.,   "Stop %",    step = .25, group = "▷ 7. MACD (Short)",              inline = "1")
S7_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 7. MACD (Short)",              inline = "2")
S7_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 7. MACD (Short)",              inline = "2")
S7_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 7. MACD (Short)",              inline = "3")
S7_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 7. MACD (Short)",              inline = "3")

S8_Activated    = input.bool    (true, "Active |  ",            group = "▷ 8. Bollinger Bands (Short)",   inline = "1")
S8_SL_Value     = input.float   (2.,   "Stop %",    step = .25, group = "▷ 8. Bollinger Bands (Short)",   inline = "1")
S8_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 8. Bollinger Bands (Short)",   inline = "2")
S8_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 8. Bollinger Bands (Short)",   inline = "2")
S8_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 8. Bollinger Bands (Short)",   inline = "3")
S8_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 8. Bollinger Bands (Short)",   inline = "3")

S9_Activated    = input.bool    (true, "Active |  ",            group = "▷ 9. Supertrend (Short)",        inline = "1")
S9_SL_Value     = input.float   (2.,   "Stop %",    step = .25, group = "▷ 9. Supertrend (Short)",        inline = "1")
S9_TP1_Value    = input.float   (1.,   "    TP 1",  step = .25, group = "▷ 9. Supertrend (Short)",        inline = "2")
S9_TP2_Value    = input.float   (2.,   "TP 2",      step = .25, group = "▷ 9. Supertrend (Short)",        inline = "2")
S9_TP3_Value    = input.float   (3.,   "    TP 3",  step = .25, group = "▷ 9. Supertrend (Short)",        inline = "3")
S9_TP4_Value    = input.float   (4.,   "TP 4",      step = .25, group = "▷ 9. Supertrend (Short)",        inline = "3")
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
// 5. BULLISH / BEARISH CONDITIONS —————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

//—————————— FAVORABLE CONDITION (means Bullish green 🠉 occurs on Long Trades and Bearish red 🠋 occurs on Short Trades)
...
//—————————— NON-FAVORABLE CONDITION (means Bearish red 🠋 occurs on Long Trades and Bullish green 🠉 occurs on Short Trades)
...
f_Entry(direction, entryActivated, tradeColor, offset, entry, bullishTrigger, bearishTrigger, trade, stopLossValue, takeProfit_1_value, takeProfit_2_value, takeProfit_3_value, takeProfit_4_value, entryText, box, i) =>
    ...
    if entryActivated 
        ...
        if RRT_Activated
            ...
            table.cell(table_id = Risk_Reward_Table, column = 20, row = 0, text = "▲",           text_color = C_LIME_GREEN,  text_size = RRT_textSize,    bgcolor = color.new(C_LIME_GREEN, 92)  , tooltip = "Bullish condition Triangle Signal")
            table.cell(table_id = Risk_Reward_Table, column = 22, row = 0, text = "▼",           text_color = C_PINK,        text_size = RRT_textSize,    bgcolor = color.new(C_PINK,       92)  , tooltip = "Bearish condition Triangle Signal")
            ...
            table.merge_cells(Risk_Reward_Table, 20, 0, 21, 0) // Bullish 🠉
            table.merge_cells(Risk_Reward_Table, 22, 0, 23, 0) // Bearish 🠋
        ...
        if TTT_Activated
            ...
            if gActive
                ...
                table.cell(table_id = Trade_Tracking_Table, column = 2, row = trade + 1, text = direction == 'L' ? close  > gEntry_Price ? "☑️" + str.tostring(math.round_to_mintick(gEntry_Price)) : str.tostring(math.round_to_mintick(gEntry_Price)) : direction == 'S' ? close < gEntry_Price ? "☑️" + str.tostring(math.round_to_mintick(gEntry_Price)) : str.tostring(math.round_to_mintick(gEntry_Price)) : str.tostring(math.round_to_mintick(gEntry_Price)),  text_color = C_BLACK, text_size = TTT_textSize, bgcolor = tradeColor )
                ...
                table.cell(table_id = Trade_Tracking_Table, column = 4, row = trade + 1, text = direction == 'L' ? close  > gTP1_Price   ? "☑️" + str.tostring(math.round_to_mintick(gTP1_Price  )) : str.tostring(math.round_to_mintick(gTP1_Price  )) : direction == 'S' ? close < gTP1_Price   ? "☑️" + str.tostring(math.round_to_mintick(gTP1_Price  )) : str.tostring(math.round_to_mintick(gTP1_Price  )) : str.tostring(math.round_to_mintick(gTP1_Price  )),  text_color = C_BLACK, text_size = TTT_textSize, bgcolor = f_gradientColor(tradeColor, gIn_Trade_Bar_Count, matrix.get(matrix, trade, RRT_Avg_TP1_Bars ), 0),     tooltip = "Color brightens as the trade gets closer to TP1's Avg age in RRT")
                table.cell(table_id = Trade_Tracking_Table, column = 5, row = trade + 1, text = direction == 'L' ? close  > gTP2_Price   ? "☑️" + str.tostring(math.round_to_mintick(gTP2_Price  )) : str.tostring(math.round_to_mintick(gTP2_Price  )) : direction == 'S' ? close < gTP2_Price   ? "☑️" + str.tostring(math.round_to_mintick(gTP2_Price  )) : str.tostring(math.round_to_mintick(gTP2_Price  )) : str.tostring(math.round_to_mintick(gTP2_Price  )),  text_color = C_BLACK, text_size = TTT_textSize, bgcolor = f_gradientColor(tradeColor, gIn_Trade_Bar_Count, matrix.get(matrix, trade, RRT_Avg_TP2_Bars ), 0),     tooltip = "Color brightens as the trade gets closer to TP2's Avg age in RRT")
                table.cell(table_id = Trade_Tracking_Table, column = 6, row = trade + 1, text = direction == 'L' ? close  > gTP3_Price   ? "☑️" + str.tostring(math.round_to_mintick(gTP3_Price  )) : str.tostring(math.round_to_mintick(gTP3_Price  )) : direction == 'S' ? close < gTP3_Price   ? "☑️" + str.tostring(math.round_to_mintick(gTP3_Price  )) : str.tostring(math.round_to_mintick(gTP3_Price  )) : str.tostring(math.round_to_mintick(gTP3_Price  )),  text_color = C_BLACK, text_size = TTT_textSize, bgcolor = f_gradientColor(tradeColor, gIn_Trade_Bar_Count, matrix.get(matrix, trade, RRT_Avg_TP3_Bars ), 0),     tooltip = "Color brightens as the trade gets closer to TP3's Avg age in RRT")
                table.cell(table_id = Trade_Tracking_Table, column = 7, row = trade + 1, text = direction == 'L' ? close  > gTP4_Price   ? "☑️" + str.tostring(math.round_to_mintick(gTP4_Price  )) : str.tostring(math.round_to_mintick(gTP4_Price  )) : direction == 'S' ? close < gTP4_Price   ? "☑️" + str.tostring(math.round_to_mintick(gTP4_Price  )) : str.tostring(math.round_to_mintick(gTP4_Price  )) : str.tostring(math.round_to_mintick(gTP4_Price  )),  text_color = C_BLACK, text_size = TTT_textSize, bgcolor = f_gradientColor(tradeColor, gIn_Trade_Bar_Count, matrix.get(matrix, trade, RRT_Avg_TP4_Bars ), 0),     tooltip = "Color brightens as the trade gets closer to TP4's Avg age in RRT")
