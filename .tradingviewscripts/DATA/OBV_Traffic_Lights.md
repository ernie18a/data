...
Source: https://www.tradingview.com/script/VoziHfu9-OBV-Traffic-Lights/

## Description

The idea with On-balance volume (OBV) is to see price movement based on volume instead of the distance between the open and close of a candle. This can be used to find the relationship between volume and price action much easier than normal volume bars.
