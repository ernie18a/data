...
Source: https://www.tradingview.com/script/rfBdCeg1-Gaps-Profile-vnhilton/

## Description

Note: If you get an error preventing indicator from executing due to a loop running longer than >500ms, please lower the amount of boxes shown and/or increase the minimum gap % threshold.
