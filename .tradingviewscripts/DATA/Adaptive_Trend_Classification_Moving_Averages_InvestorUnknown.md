...
Source: https://www.tradingview.com/script/L6NreqzB-Adaptive-Trend-Classification-Moving-Averages-InvestorUnknown/
...
[image]https://www.tradingview.com/x/4glAaxZh/[/image]
...
[image]https://www.tradingview.com/x/3gSDpTde/[/image]

[image]https://www.tradingview.com/x/2gjFpEs7/[/image]
...
SetOfMovingAverages(length, source, ma_type) =>
    ...
    [MA, MA1, MA2, MA3, MA4, MA_1, MA_2, MA_3, MA_4][/pine]

Exponential Growth Factor: Computes an exponential growth factor based on the current bar index and growth rate.

[pine]// The function `e(L)` calculates an exponential growth factor based on the current bar index and a given growth rate `L`.
e(L) =>
...
[pine]// This function calculates the equity based on the starting equity, signals, and rate of change (R).
...
[image]https://www.tradingview.com/x/Uw1xgl7Q/[/image]
