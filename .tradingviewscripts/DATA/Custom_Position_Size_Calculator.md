<!-- tradingview-pine-id: PUB;0f996c444dd7465a8eba3301abc49548 -->
<!-- tradingviewscripts-format: 1 -->
# Custom Position Size Calculator

Source: https://www.tradingview.com/script/rFpVUwLm-Custom-Position-Size-Calculator-v2/

## Description

Custom Position Size Calculator (v2)

Simple and accurate position size calculator for discretionary traders.

Just enter your account size, risk %, pip value, TP and SL in pips — and it instantly shows:
• Exact lot size based on your risk
• Risk/Reward ratio
• Potential profit
• How much you’re actually risking in money
• The win rate you need just to break even

Works on basically any instrument. Just set the correct pip value (most USD pairs = 10, Gold = 1, etc.).

Everything updates live as soon as you change an input. No need to leave the chart or open some external calculator.

Quick guide:
1. Put in your account size
2. Choose how much % you’re willing to risk (e.g. 0.5–1%)
3. Set the pip value of the instrument you’re trading
4. Enter your TP and SL in pips (e.g. use the TradingView position tool)

That’s it. It does the rest.

Useful whether you’re just starting out and want to size trades properly, or you’ve been trading for years and just want something fast and clean on the chart.
...
````pine
//@version=6
indicator("Custom Position Size Calculator", overlay = true)
