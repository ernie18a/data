<!-- tradingview-pine-id: PUB;d5ef594eae4e40df86d03e0872bce30c -->
<!-- tradingviewscripts-format: 1 -->
# Trailing Management (Zeiierman)

Source: https://www.tradingview.com/script/p5gGWHl5-Trailing-Management-Zeiierman/
...
[image]https://www.tradingview.com/x/CcJBfEzI/[/image]
...
[image]https://www.tradingview.com/x/HMsfuLOS/[/image]
...
Bullish
[image]https://www.tradingview.com/x/83h7AoR8/[/image]

Bearish
[image]https://www.tradingview.com/x/hZK88naM/[/image]
...
[image]https://www.tradingview.com/x/TWymJqbW/[/image]
...
[image]https://www.tradingview.com/x/ugBt49O9/[/image]
...
[image]https://www.tradingview.com/x/GJIt7rfs/[/image]
...
[image]https://www.tradingview.com/x/ogN0VzeV/[/image]
...
posi = input.string(position.top_right, title = '', options = [position.top_right, position.top_center, position.top_left, position.bottom_right, position.bottom_center, position.bottom_left, position.middle_right, position.middle_left], group = 'Table', inline = 'style', tooltip = '')
...
if barstate.islast
    ...
    if showBE
        ...
        dot := label.new(chart.point.from_index(b + 100 + int(wr), lo + y), style = label.style_circle, color = color.yellow, size = size.tiny)
        (dot[1]).delete()
