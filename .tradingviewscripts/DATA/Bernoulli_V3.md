...
Source: https://www.tradingview.com/script/bvYZ1CdF-Bernoulli-Process-Binary-Entropy-Function/

## Description

This indicator is the Bernoulli Process or [Wikipedia - Binary Entropy Function](https://en.wikipedia.org/wiki/Binary_entropy_function). Within Information Theory, Entropy is the measure of available information, here we use a binary variable 0 or 1 (P) and (1-P) (Bernoulli Function/Distribution), and combined with the [Shannon Entropy](https://www.tradingview.com/script/90gGxKtX-Shannon-Entropy-V2/) measurement. As you can see below, it produces some wonderful charts and signals, using price, volume, or both summed together. The chart below shows you a couple of options and some critical details on the indicator. The best part about this is the simplicity, all of this information in a couple of lines of code.
...
[image]https://www.tradingview.com/x/dyW3gxbh/[/image]
...
BTC-Strategy 
[image]https://www.tradingview.com/x/sHtDEaoL/[/image]

Stock-Strategy (#loveyouNFLX)
https://www.tradingview.com/x/0dmTb6iG/

FOREX - (for everyone hopped up on 40X leverage)
https://www.tradingview.com/x/yIouVPIC/
