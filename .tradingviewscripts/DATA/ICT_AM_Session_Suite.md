<!-- tradingview-pine-id: PUB;0239827ff4ad48de841a3082dae4862c -->
<!-- tradingviewscripts-format: 1 -->
# ICT AM Session Suite

Source: https://www.tradingview.com/script/YwejGDnf-bmsAMict1/

## Description

this is my ict am model i use for setting up my lines wihtout having to do it every day hope you like this
...
grp2 = "True Opens"
showDayOpen    = input.bool(true, "Show True Day Open (00:00)",    group=grp2)
colDayOpen     = input.color(color.white,  "True Day Open Color",    group=grp2)
showAsiaOpen   = input.bool(true, "Show True Asia Open (19:30)",   group=grp2)
colAsiaOpen    = input.color(color.yellow, "True Asia Open Color",   group=grp2)
showLondonOpen = input.bool(true, "Show True London Open (01:30)", group=grp2)
colLondonOpen  = input.color(color.blue,   "True London Open Color", group=grp2)
showNYOpen     = input.bool(true, "Show True NY Open (07:30)",     group=grp2)
colNYOpen      = input.color(color.orange, "True NY Open Color",     group=grp2)
...
if showDayOpen and dayOpenTrig
...
if showAsiaOpen and asiaOpenTrig
...
if showLondonOpen and londonOpenTrig
