<!-- tradingview-pine-id: PUB;4d2cd8a888434d4fa498484343394105 -->
<!-- tradingviewscripts-format: 1 -->
# ICT Liquidity Lines (MTF)

Source: https://www.tradingview.com/script/8xfx6luw/

## Description

updated version =D
 hope it works now like it did before
...
highColor       = input.color(color.rgb(47, 6, 142), "Swing High Line Color")
lowColor        = input.color(color.rgb(207, 11, 11, 10),  "Swing Low Line Color")
