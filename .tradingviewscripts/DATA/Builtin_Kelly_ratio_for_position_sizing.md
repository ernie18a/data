<!-- tradingview-pine-id: PUB;Ts33bDEy4CQIFQYKAJUYwwUlUXRlAG2Y -->
<!-- tradingviewscripts-format: 1 -->
# Built-in Kelly ratio for position sizing

Source: https://www.tradingview.com/script/bFXf4IXh-Built-in-Kelly-ratio-for-dynamic-position-sizing/

## Description

This is the defaut keltners channel strategy with a few additions.
The main purpose is to show how we include the[ Kelly ratio](https://en.wikipedia.org/wiki/Kelly_criterion) into our scripts for dynamic position sizing based on the performance of the strategy on a per trade basis.
