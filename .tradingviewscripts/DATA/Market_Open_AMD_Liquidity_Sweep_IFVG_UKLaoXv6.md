...
inAccumulation = not na(
     time(timeframe.period, accSession, TZ)
)

inManipulation = not na(
     time(timeframe.period, manSession, TZ)
)

inDistribution = not na(
     time(timeframe.period, distSession, TZ)
)
...
if liquidityWindow
    ...
    if not liquidityWindow[1]
        ...
        liquidityHigh := math.max(
             liquidityHigh,
             high
        )

        liquidityLow := math.min(
             liquidityLow,
             low
        )
...
// ============================================================================
// LOCK MANIPULATION BOX WHEN MANIPULATION ENDS
// ============================================================================
...
// ============================================================================
// DISTRIBUTION RE-ENTRY CONFIRMATION
// ============================================================================
...
// ============================================================================
// DOWNSIDE MANIPULATION -> RE-ENTRY
// ============================================================================

if (
     amdBoxModel == "Staggered Breakout Model" and
     manipulationDirection == -1 and
     not distributionTriggered and
     inDistribution
)

    if insideAccumulation
...
if (
    ...
    // ------------------------------------------------------------------------
    // DOWNSIDE MANIPULATION
    // Distribution forms upward from accumulation low.
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    // UPSIDE MANIPULATION
    // Distribution forms downward from accumulation high.
    // ------------------------------------------------------------------------
...
// ============================================================================
// UPDATE STAGGERED DISTRIBUTION BOX
// ============================================================================
...
previousHigh = ta.highest(
     high[1],
     liquiditySweepLookback
)

previousLow = ta.lowest(
     low[1],
     liquiditySweepLookback
)
