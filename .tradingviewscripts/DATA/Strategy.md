...
Source: https://www.tradingview.com/script/mCOgJC67-Strategy/
...
  These functions can be used to plot stop or take profit levels on the chart, or as arguments to the `limit` and `stop` parameters in [strategy.exit()](https://www.tradingview.com/pine-script-reference/v5/#fun_strategy{dot}exit) function calls.
...
[image]https://www.tradingview.com/x/suMXojFM/[/image]
